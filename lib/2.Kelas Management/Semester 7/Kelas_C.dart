...
class Management7c extends StatelessWidget {
  const Management7c({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/7/c.json");
