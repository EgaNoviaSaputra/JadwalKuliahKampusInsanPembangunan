...
class Management8d extends StatelessWidget {
  const Management8d({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/8/d.json");
