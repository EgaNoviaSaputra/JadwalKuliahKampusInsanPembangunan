...
class Management4d extends StatelessWidget {
  const Management4d({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/4/d.json");
