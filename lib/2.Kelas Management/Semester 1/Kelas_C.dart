...
class Management1c extends StatelessWidget {
  const Management1c({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
        "https://http-request-post-default-rtdb.firebaseio.com/management/1/c.json");
