...
class Management6e extends StatelessWidget {
  const Management6e({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/6/e.json");
