...
class Management6b extends StatelessWidget {
  const Management6b({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/6/b.json");
