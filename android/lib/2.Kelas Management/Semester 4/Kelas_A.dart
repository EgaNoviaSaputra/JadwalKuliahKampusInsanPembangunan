...
class Management4a extends StatelessWidget {
  const Management4a({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
        "https://http-request-post-default-rtdb.firebaseio.com/management/4/a.json");
