...
class Management2c extends StatelessWidget {
  const Management2c({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/2/c.json");
