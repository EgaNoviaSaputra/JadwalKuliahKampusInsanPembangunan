...
class Management2a extends StatelessWidget {
  const Management2a({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/2/a.json");
