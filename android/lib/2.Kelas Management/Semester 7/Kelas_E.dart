...
class Management7e extends StatelessWidget {
  const Management7e({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
      "https://http-request-post-default-rtdb.firebaseio.com/management/7/e.json");
