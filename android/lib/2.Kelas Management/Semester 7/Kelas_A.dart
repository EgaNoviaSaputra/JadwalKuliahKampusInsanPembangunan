...
class Management7a extends StatelessWidget {
  const Management7a({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/7/a.json");
