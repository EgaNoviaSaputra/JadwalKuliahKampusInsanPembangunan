...
class Management3c extends StatelessWidget {
  const Management3c({Key? key}) : super(key: key);
...
Future<void> initialData() async {
    ...
    Uri url = Uri.parse(
       "https://http-request-post-default-rtdb.firebaseio.com/management/3/c.json");
